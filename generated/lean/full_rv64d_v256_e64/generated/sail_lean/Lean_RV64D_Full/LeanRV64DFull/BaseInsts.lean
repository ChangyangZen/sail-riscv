...
/-- Type quantifiers: k_ex591636_ : Bool, width : Nat, width ∈ {1, 2, 4, 8} -/
def valid_load_encdec (width : Nat) (is_unsigned : Bool) : Bool :=
  ((width <b xlen_bytes) || ((not is_unsigned) && (width ≤b xlen_bytes)))

/-- Type quantifiers: k_ex591639_ : Bool, k_n : Nat, k_n ≥ 0, 0 < k_n ∧ k_n ≤ xlen -/
...
/-- Type quantifiers: k_ex591640_ : Bool -/
...
/-- Type quantifiers: k_ex591641_ : Bool -/
